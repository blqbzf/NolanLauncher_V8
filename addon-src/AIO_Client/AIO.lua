if not message then message = function(msg) print(msg) end end
--[[
...
if AIO_SERVER then
    ...
    LibWindow = LibStub and pcall(function() return LibStub("LibWindow-1.1") end) and LibStub("LibWindow-1.1") or nil
end
